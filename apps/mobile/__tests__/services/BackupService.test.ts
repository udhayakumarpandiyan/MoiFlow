...
jest.mock('../../src/common/database/db', () => ({
...
jest.mock('../../src/common/services/GoogleDriveService', () => ({
  googleDriveService: {
...
jest.mock('../../src/common/services/SettingsService', () => ({
  settingsService: {
...
import { BackupService } from '../../src/common/services/BackupService';
import { GoogleDriveError } from '../../src/common/services/GoogleDriveService';
