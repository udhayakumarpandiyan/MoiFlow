...
import { voiceSearchService } from '@common/services';
import { VoiceSearchService } from '@common/voice/VoiceSearchService';
import { VoiceSearchResult } from '@common/voice/VoiceSearchService';
