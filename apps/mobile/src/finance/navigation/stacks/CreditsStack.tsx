...
const LazyCredits = React.lazy(() => import('@finance/screens/CreditsScreen'));
const LazyAddEditCredit = React.lazy(() => import('@finance/screens/AddEditCreditScreen'));
const LazyCreditDetail = React.lazy(() => import('@finance/screens/CreditDetailScreen'));
