...
const LazyBusiness = React.lazy(() => import('@finance/screens/business/BusinessScreen'));
const LazyPartyDetail = React.lazy(() => import('@finance/screens/business/PartyDetailScreen'));
const LazyAddEditParty = React.lazy(() => import('@finance/screens/business/AddEditPartyScreen'));
const LazyTransactionDetail = React.lazy(() => import('@finance/screens/business/TransactionDetailScreen'));
const LazyAddEditTransaction = React.lazy(() => import('@finance/screens/business/AddEditTransactionScreen'));
